...
return cljs.core._write.call(null,writer__6814__auto__,"reagent.impl.template/NativeWrapper");
});
...
var or__6207__auto__ = reagent.impl.template.named_QMARK_.call(null,x);
...
var or__6207__auto__ = reagent.impl.template.hiccup_tag_QMARK_.call(null,x);
if(cljs.core.truth_(or__6207__auto__)){
return or__6207__auto__;
} else {
...
var G__7759 = o;
(G__7759[reagent.impl.template.cached_prop_name.call(null,k)] = reagent$impl$template$convert_prop_value.call(null,v));
...
var old_7763 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_.call(null,old_7763))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_7763)].join(''):class$));
} else {
}
...
if(cljs.core.not.call(null,(function (){var and__6195__auto__ = (node === document.activeElement);
if(and__6195__auto__){
var and__6195__auto____$1 = reagent.impl.template.has_selection_api_QMARK_.call(null,(node["type"]));
...
var G__7766 = jsprops;
(G__7766["defaultValue"] = value);

(G__7766["onChange"] = ((function (G__7766,v,value,on_change){
return (function (p1__7764_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__7764_SHARP_);
});})(G__7766,v,value,on_change))
);
...
var vec__7768 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__7768,(0),null);
var id = cljs.core.nth.call(null,vec__7768,(1),null);
var class$ = cljs.core.nth.call(null,vec__7768,(2),null);
...
var temp__4659__auto__ = (function (){var G__7772 = cljs.core.meta.call(null,v);
if((G__7772 == null)){
return null;
} else {
return reagent.impl.template.get_key.call(null,G__7772);
}
})();
if((temp__4659__auto__ == null)){
...
var jsprops = {"argv": v};
var G__7774_7775 = v;
var G__7774_7776__$1 = (((G__7774_7775 == null))?null:reagent.impl.template.key_from_vec.call(null,G__7774_7775));
if((G__7774_7776__$1 == null)){
} else {
(jsprops["key"] = G__7774_7776__$1);
}
...
var p = (function (){var temp__4659__auto__ = (function (){var G__7779 = cljs.core.meta.call(null,argv);
if((G__7779 == null)){
return null;
} else {
return reagent.impl.template.get_key.call(null,G__7779);
}
})();
if((temp__4659__auto__ == null)){
return jsprops;
...
var G__7780 = (((jsprops == null))?{}:jsprops);
(G__7780["key"] = key);
...
var G__7781 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__7781;
continue;
}
} else {
...
var n__7121__auto___7782 = a.length;
var i_7783 = (0);
while(true){
if((i_7783 < n__7121__auto___7782)){
(a[i_7783] = reagent.impl.template.as_element.call(null,(a[i_7783])));
...
var a = cljs.core.into_array.call(null,s);
var n__7121__auto___7785 = a.length;
var i_7786 = (0);
while(true){
if((i_7786 < n__7121__auto___7785)){
var val_7787 = (a[i_7786]);
if((cljs.core.vector_QMARK_.call(null,val_7787)) && ((reagent.impl.template.key_from_vec.call(null,val_7787) == null))){
(o["no-key"] = true);
} else {
}

(a[i_7786] = reagent.impl.template.as_element.call(null,val_7787));

var G__7788 = (i_7786 + (1));
i_7786 = G__7788;
continue;
} else {
}
...
if(cljs.core.truth_((function (){var and__6195__auto__ = cljs.core.not.call(null,reagent.impl.component._STAR_non_reactive_STAR_);
if(and__6195__auto__){
return (ctx["no-key"]);
} else {
return and__6195__auto__;
...
var G__7790 = (cljs.core.count.call(null,argv) - first_child);
switch (G__7790) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__7790){
