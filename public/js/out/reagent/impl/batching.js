...
var c_7695 = (a[i]);
if(cljs.core.truth_((c_7695["cljsIsDirty"]))){
(c_7695["forceUpdate"])();
} else {
}
...
return cljs.core._write.call(null,writer__6814__auto__,"reagent.impl.batching/RenderQueue");
});
...
var G__7699 = c;
var G__7699__$1 = (((G__7699 == null))?null:(G__7699["props"]));
if((G__7699__$1 == null)){
return null;
} else {
return (G__7699__$1["argv"]);
}
});
...
var G__7701_7702 = (c["cljsRatom"]);
if((G__7701_7702 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__7701_7702);
}
